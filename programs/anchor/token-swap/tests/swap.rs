...
//! |------|------|---------------|---------|---------|
//! | `test_swap_spl` | SPL | SPL associated token accounts | SPL | SPL mints work with Light Token vault |
//! | `test_swap_t22` | Token 2022 | Token 2022 associated token accounts | Token 2022 | Token 2022 mints work with Light Token vault |
//! | `test_swap_light` | Light Token | Light Token accounts | SPL | Light Token mints, SPL LP mint |
//! | `test_swap_spl_light` | SPL | Light Token accounts | SPL | SPL mint, converted user accounts |
//! | `test_swap_t22_light` | Token 2022 | Light Token accounts | Token 2022 | Token 2022 mint, converted user accounts |
//! | `test_swap_full_light` | Light Token | Light Token accounts | Light Token | Fully rent-free (Light Token LP mint) |
//!
...
/// SPL mint with SPL associated token accounts, SPL LP mint, and Light Token pool vaults.
///
...
/// Token 2022 mint with Token 2022 associated token accounts, Token 2022 LP mint, and Light Token pool vaults.
///
...
/// which only supports SPL/Token 2022 mints.
#[tokio::test]
...
/// Create depositor LP associated token account and send `deposit_liquidity` instruction.
///
