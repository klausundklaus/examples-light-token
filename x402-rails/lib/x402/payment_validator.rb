...
module X402
  class PaymentValidator
    ...
    def validate(payment_payload, requirement)
      ...
      # For Solana/Light Token chains, the facilitator handles all validation of the transaction
      if payment_payload.evm_chain?
        ...
        # Light Token: verify transaction payload exists (uses CToken program)
