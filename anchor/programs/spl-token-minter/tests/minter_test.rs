//! Integration tests for Light mint creation using #[light_account(init, mint)] macro.
...
async fn test_mint_to() {
    ...
    println!("Mint Signer PDA: {:?}", mint_signer_pda);
    println!("Light Mint PDA: {:?}", cmint_pda);
    ...
    println!("Light mint created successfully!");
    ...
    println!("\n=== mint_to test completed successfully! ===");
}
